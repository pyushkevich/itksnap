...
void
AnnotationNewRenderer::DrawLineLength(AbstractNewRenderContext *context,
                                      const Vector3d           &xSlice1,
                                      const Vector3d           &xSlice2,
                                      const Vector3d           &color,
                                      double                    alpha)
...
void
AnnotationNewRenderer::DrawSelectionHandle(AbstractNewRenderContext *context, const Vector3d &xSlice)
{
  // Determine the width of the line
...
void
AnnotationNewRenderer::RenderOverTiledLayer(AbstractNewRenderContext *context,
