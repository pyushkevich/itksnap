...
GenericSliceRenderer::SetModel(GenericSliceModel *model)
{
  ...
  Rebroadcast(m_Model->GetDriver(), CursorUpdateEvent(), CursorUpdateEvent());
...
void GenericSliceRenderer::OnUpdate()
{
  ...
  bool cursor_updated = m_EventBucket->HasEvent(CursorUpdateEvent());
  ...
  if (cursor_updated)
    std::cout << "[GSR] Cursor Updated" << std::endl;
}
