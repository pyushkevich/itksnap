...
void
GenericSliceNewRenderer::SetModel(GenericSliceModel *model)
{
  m_Model = model;
...
GenericSliceNewRenderer::TextureInfo
GenericSliceNewRenderer::GetTexture(AbstractNewRenderContext *context,
...
void
GenericSliceNewRenderer::RenderLayer(AbstractNewRenderContext *context,
                                     TextureCache             &texture_cache,
                                     ImageWrapperBase         *layer,
                                     bool                      bilinear,
...
void
GenericSliceNewRenderer::Render(AbstractNewRenderContext *context)
{
...
void
GenericSliceNewRenderer::OnUpdate()
{
