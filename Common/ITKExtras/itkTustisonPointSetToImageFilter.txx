...
=========================================================================*/
#ifndef _itkTustisonPointSetToImageFilter_txx
#define _itkTustisonPointSetToImageFilter_txx
...
TustisonPointSetToImageFilter<TInputPointSet,TOutputImage>
...
template <class TInputPointSet, class TOutputImage>
const typename TustisonPointSetToImageFilter<TInputPointSet,TOutputImage>::InputPointSetType *
TustisonPointSetToImageFilter<TInputPointSet,TOutputImage>
::GetInput(void) 
{
...
{
  unsigned int i;
  itkDebugMacro(<< "TustisonPointSetToImageFilter::Update() called");
  ...
  itkDebugMacro(<< "TustisonPointSetToImageFilter::Update() finished");
