...
include("${BundleUtilities_cmake_dir}/GetPrerequisites2.cmake")
...
function(get_item_rpaths item rpaths_var)
  ...
  if(otool_cmd)
    ...
    message("otool returns ${load_cmds_ov}")
...
function(set_bundle_key_values keys_var context item exepath dirs copyflag)
  ...
  message("set_bundle_key_values on ITEM ${item} KEY ${key}")
  ...
  if(NOT length_before EQUAL length_after)
    ...
    message("get_item_rpaths returned ${item_rpaths}")
...
function(fixup_bundle_item resolved_embedded_item exepath dirs)
  message("fixup_bundle_item ${resolved_embedded_item} EXEPATH ${exepath} DIRS ${dirs}")
  ...
  message("RPATHS for ${ikey} are ${rpaths}")
