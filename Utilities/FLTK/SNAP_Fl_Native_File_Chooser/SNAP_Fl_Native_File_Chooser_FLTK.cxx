...
int SNAP_Fl_Native_File_Chooser::type_fl_file(int val) {
  switch (val) {
    case BROWSE_FILE:
...
/**
  Sets the current SNAP_Fl_Native_File_Chooser::Type of browser.
 */
...
/**
  Gets the current SNAP_Fl_Native_File_Chooser::Type of browser.
 */
...
/**
  ...
  \p val is expected to be one or more SNAP_Fl_Native_File_Chooser::Option flags ORed together.
...
/**
  Gets the platform specific SNAP_Fl_Native_File_Chooser::Option flags.
*/
 ...
 */
void SNAP_Fl_Native_File_Chooser::filter_value(int val) {
  _filtvalue = val;
}
...
int SNAP_Fl_Native_File_Chooser::exist_dialog() {
